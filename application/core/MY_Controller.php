...
abstract class MY_Controller extends CI_Controller {
    ...
    /**
     * The LDAP Distinguished Name of the UserController post authentication
     *
     * @var string
     */
    ...
    protected function _perform_ldap_auth($username = '', $password = NULL)
    {
        ...
        {
            log_message('error', 'LDAP Auth: UserController '.$username.' not found in search');
            return FALSE;
        }
        ...
        // UserController found, could not authenticate as user
    ...
    protected function _prepare_basic_auth()
    {
        ...
        elseif ($http_auth !== NULL)
        {
            ...
            // HTTP_AUTHORIZATION e.g. my_username:my_password. This is passed in the kjkjkjhtaccess file
